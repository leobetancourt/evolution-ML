 ...
 listener.BeginContact = function(contact) {
   for (var i = 0; i < population.creatures.length; i++) {
     ...
     } else if (contact.GetFixtureB().GetBody().GetUserData() == 'calfA2' + i || contact.GetFixtureA().GetBody().GetUserData() == 'calfA2' + i) {
       population.creatures[i].calfA2Touch = 1;
     } else if (contact.GetFixtureB().GetBody().GetUserData() == 'calfB2' + i || contact.GetFixtureA().GetBody().GetUserData() == 'calfB2' + i) {
     ...
     if (contact.GetFixtureB().GetBody().GetUserData() == 'torso' + i || contact.GetFixtureA().GetBody().GetUserData() == 'torso' + i) {
       ...
       //population.creatures[i].crash = true;
     } else if (contact.GetFixtureB().GetBody().GetUserData() == 'thighA2' + i || contact.GetFixtureA().GetBody().GetUserData() == 'thighA2' + i) {
       //population.creatures[i].crash = true;
     } else if (contact.GetFixtureB().GetBody().GetUserData() == 'thighB2' + i || contact.GetFixtureA().GetBody().GetUserData() == 'thighB2' + i) {
       //population.creatures[i].crash = true;
     }
   }
 }
