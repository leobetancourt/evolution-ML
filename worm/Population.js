...
function Population() {
  ...
  this.update = function() {
    for (var i = this.creatures.length - 1; i >= 0; i--) {
      ...
      if (this.creatures[i].crash && this.creatures[i].diedAlready === false) {
        ...
        //Destroy Bodies
        world.DestroyBody(this.creatures[i].limbs.head);
        world.DestroyBody(this.creatures[i].limbs.legA);
        world.DestroyBody(this.creatures[i].limbs.legB);
        world.DestroyBody(this.creatures[i].limbs.legC);
        world.DestroyBody(this.creatures[i].limbs.legD);
        world.DestroyBody(this.creatures[i].limbs.legE);
  ...
  this.moveCamera = function() {
    ...
    var creaturepos = this.creatures[maxcreature].limbs.legB.GetPosition();
